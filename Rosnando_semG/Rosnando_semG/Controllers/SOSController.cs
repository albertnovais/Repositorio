...
namespace Rosnando_semG.Controllers
{
    public class SOSController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            var sos = bd.Dica.Where(x => x.TipoDica.primeiro_socorros == true).ToList();
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.tipodica = new SelectList(bd.TipoDica.Where(x => x.primeiro_socorros == true), "tipo_dica_id", "descricao");
            return View();
        }
        [HttpPost]
        ...
        public ActionResult Details(int dica_id)
        {
            ...
            var sos = bd.Dica.FirstOrDefault(x => x.dica_id == dica_id);
